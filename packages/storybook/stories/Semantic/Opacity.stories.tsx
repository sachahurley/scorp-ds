  ...
  return (
    <div className="min-h-screen bg-surface-page p-8 font-mono text-sm text-secondary-900 dark:text-secondary-50">
      ...
      <p className="mb-4 max-w-3xl text-secondary-800 dark:text-secondary-300">
        ...
        <code className="text-primary-800 dark:text-primary-400">surface.overlay</code>).
      </p>
        ...
        <div className="flex max-w-3xl flex-wrap gap-3 border border-secondary-300 bg-surface-page p-4 dark:border-secondary-700">
          {STEPS.map((step) => (
            <div key={step} className="text-center">
              ...
              <div className="mt-1 text-xs text-secondary-800 dark:text-secondary-300">{step}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="code" className="mb-8">
        ...
        <p className="mb-4 text-secondary-800 dark:text-secondary-300">
          Reference the variable in <code className="text-primary-800 dark:text-primary-400">opacity</code> or in alpha compositing — avoid
...
/>`}
      ...
      <section aria-labelledby="related-heading">
        ...
        <p className="text-secondary-800 dark:text-secondary-300">
          Pair with <strong>Semantic / Colors</strong> for <code className="text-primary-800 dark:text-primary-400">surface.overlay</code> and
